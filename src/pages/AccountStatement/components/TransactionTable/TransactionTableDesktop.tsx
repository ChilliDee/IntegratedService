...
export const TransactionTableDesktop: React.FC<
      ...
      <table className="w-full">
        <thead>
          <tr className="bg-[#BFE2FF]/5">
            <th className="px-6 py-4 text-left text-sm font-medium text-[#09365B]">
              Date
            </th>
            <th className="px-6 py-4 text-left text-sm font-medium text-[#09365B]">
              Description
            </th>
            <th className="px-6 py-4 text-right text-sm font-medium text-[#09365B]">
              Debits
            </th>
            <th className="px-6 py-4 text-right text-sm font-medium text-[#09365B]">
              Credits
        ...
        <tbody>
          {Object.values(transactions).map((t, index) => (
            ...
            >
              <td className={`px-6 py-4 text-sm text-[#09365B] font-bold`}>
                {t.transactionDate}
              </td>
              <td className={`px-6 py-4 text-sm text-[#09365B] font-bold`}>
                {t.description}
